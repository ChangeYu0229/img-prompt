...
export const metadata: Metadata = {
  title: "MJ/SD 提示词 - Stable Diffusion 和 Midjourney 的图像提示词生成工具",
  description:
    "MJ/SD 提示词 是一个直观的图像提示词生成工具，可以方便地在 Stable Diffusion 和 Midjourney 的流程中使用，使图像提示词的创建变得简单而有效，轻松激发创意并获得更好的图片结果。通过 MJ/SD 提示词，你可以将自己的创意想法转化为视觉现实。",
};
